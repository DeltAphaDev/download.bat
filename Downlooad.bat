...
echo    WScript.Quit  
echo Else  
echo    Const Copyright ="By DeltAlphaDev"
echo    Dim Title : Title = "Downloading file ....."
...
start "Play Music" /Min cscript.exe //nologo "%Temp%\PlayMusic.vbs"
exit /b
::**************************************************************************************
:StopMusic
